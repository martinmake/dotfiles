...
/* styles */
/*
 * The iteration will stop at the first match, beginning at the b{}eginning of
 * the list.
 */
...
// 	vertical and horizontal scrolling in viewport percentage
	...
	{ 0|GDK_CONTROL_MASK    , GDK_KEY_q      , zoom               , { .i =  0 }              },
	...
	{ 0|GDK_CONTROL_MASK    , GDK_KEY_p      , print              , { 0 }                    },
	{ 0|GDK_CONTROL_MASK    , GDK_KEY_t      , showcert           , { 0 }                    },

// 	{ 0|GDK_SHIFT_MASK      , GDK_KEY_a      , togglecookiepolicy , { 0 }                    },
	{ 0                     , GDK_KEY_F11    , togglefullscreen   , { 0 }                    },
	{ 0|GDK_SHIFT_MASK      , GDK_KEY_i      , toggleinspector    , { 0 }                    },

// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_c      , toggle             , { .i = CaretBrowsing   } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_f      , toggle             , { .i = FrameFlattening } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_g      , toggle             , { .i = Geolocation     } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_s      , toggle             , { .i = JavaScript      } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_l      , toggle             , { .i = LoadImages      } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_v      , toggle             , { .i = Plugins         } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_b      , toggle             , { .i = ScrollBars      } },
// 	{ 0|GDK_CONTROL_MASK    , GDK_KEY_t      , toggle             , { .i = StrictTLS       } },
	{ 0|GDK_CONTROL_MASK    , GDK_KEY_z      , toggle             , { .i = Style           } },
