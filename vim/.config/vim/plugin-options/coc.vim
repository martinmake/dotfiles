...
" hi link CocSelectedText SelectedText
" hi link CocCodeLens     CodeLens
hi link CocHighlightText HighlightText
...
"   inoremap <expr> <cr> :call complete_info()["selected"] != "-1" ? "\<C-y>" : "\<C-g>u\<CR>"
" else
"   imap <expr> <cr> :call pumvisible() ? "\<C-y>" : "\<C-g>u\<CR>"
" endif
